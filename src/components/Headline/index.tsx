...
const Headline = () => {
  return (
    <div className={`${styles.headline}`}>
        ...
        <p className={styles.headline__description}>If you seek professional guidance in front-end development, strive to propel your career to greater heights, or require training in ReactJS/JAMStack for yourself or your team, do not hesitate to initiate contact.</p>
